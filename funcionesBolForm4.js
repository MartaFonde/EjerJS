...
function resultado() {
    ...
    // valido = op(n1, document.getElementById('erro1'));
    // valido = op(n2, document.getElementById('erro2'));
    if (valido) {
...
// function op(n, id) {
//     if (n.length == 0) {
//         document.id.innerHTML = "Este campo no puede estar vacío";
//         return false;
//     } else {
//         return true;
//     }
...
function nuevoCampo() {
    ...
    var operando2 = formulario.getElementsByTagName('input')[2];
    formulario.insertBefore(campo, operando2);
}